...
class UpiPaymentsPage extends StatefulWidget {
  const UpiPaymentsPage({super.key});
...
class _UpiPaymentsPageState extends State<UpiPaymentsPage> {
  ...
  Future<UpiResponse> initiateTransaction(UpiApp app) async {
    ...
    return _upiIndia.startTransaction(
      app: app,
      receiverUpiId: "rajuperike8143-3@oksbi",
      receiverName: 'MyPhotoEdit',
      transactionRefId: 'MYPEDT${now.month}${now.day}${now.hour}${now.second}',
      transactionNote: 'Paying for photo edit',
      amount: 1.00,
    );
  }
